...
public static class KMBombInfoExtensions
{
    ...
    private static IEnumerable<T> GetJSONEntries<T>(KMBombInfo bombInfo, string queryKey, string queryInfo) where T : new() { return bombInfo.QueryWidgets(queryKey, queryInfo).Select(JsonConvert.DeserializeObject<T>); }

    private static IEnumerable<IndicatorJSON> GetIndicatorEntries(KMBombInfo bombInfo) { return GetJSONEntries<IndicatorJSON>(bombInfo, KMBombInfo.QUERYKEY_GET_INDICATOR, null); }
    ...
    public static bool IsIndicatorPresent(this KMBombInfo bombInfo, Indicator indicatorLabel) { return bombInfo.IsIndicatorPresent(indicatorLabel.ToString()); }
    ...
    public static bool IsIndicatorOn(this KMBombInfo bombInfo, Indicator indicatorLabel) { return bombInfo.IsIndicatorOn(indicatorLabel.ToString()); }

    public static bool IsIndicatorOn(this KMBombInfo bombInfo, string indicatorLabel) { return GetIndicatorEntries(bombInfo).Any(x => x.IsOn() && indicatorLabel.Equals(x.label)); }
    ...
    public static IEnumerable<string> GetIndicators(this KMBombInfo bombInfo) { return GetIndicatorEntries(bombInfo).Select(x => x.label); }

    public static IEnumerable<string> GetOnIndicators(this KMBombInfo bombInfo) { return GetIndicatorEntries(bombInfo).Where(x => x.IsOn()).Select(x => x.label); }
	...
	public static int GetBatteryCount(this KMBombInfo bombInfo, int batteryType) { return GetBatteryEntries(bombInfo).Where(x => x.numbatteries == batteryType)
            .Sum(x => x.numbatteries); }

    public static int GetBatteryHolderCount(this KMBombInfo bombInfo) { return GetBatteryEntries(bombInfo).Count(); }
    ...
    public static int GetBatteryHolderCount(this KMBombInfo bombInfo, int batteryType) { return GetBatteryEntries(bombInfo).Count(x => x.numbatteries == batteryType); }

    public static int GetPortCount(this KMBombInfo bombInfo) { return GetPortEntries(bombInfo).Sum(x => x.presentPorts.Length); }

    public static int GetPortCount(this KMBombInfo bombInfo, Port portType) { return bombInfo.GetPortCount(portType.ToString()); }

    public static int GetPortCount(this KMBombInfo bombInfo, string portType) { return GetPortEntries(bombInfo).Sum(x => x.presentPorts.Count(y => portType.Equals(y))); }

    public static int GetPortPlateCount(this KMBombInfo bombInfo) { return GetPortEntries(bombInfo).Count(); }

    public static IEnumerable<string> GetPorts(this KMBombInfo bombInfo) { return GetPortEntries(bombInfo).SelectMany(x => x.presentPorts); }

    public static IEnumerable<string[]> GetPortPlates(this KMBombInfo bombInfo) { return GetPortEntries(bombInfo).Select(x => x.presentPorts); }

    public static bool IsPortPresent(this KMBombInfo bombInfo, Port portType) { return bombInfo.IsPortPresent(portType.ToString()); }

    public static bool IsPortPresent(this KMBombInfo bombInfo, string portType) { return GetPortEntries(bombInfo).Any(x => x.presentPorts != null && x.presentPorts.Any(y => portType.Equals(y))); }
    ...
    public static bool IsDuplicatePortPresent(this KMBombInfo bombInfo, Port port) { return IsDuplicatePortPresent(bombInfo, port.ToString()); }

    public static bool IsDuplicatePortPresent(this KMBombInfo bombInfo, string port) { return GetPortCount(bombInfo, port) > 1; }
	...
	public static IEnumerable<char> GetSerialNumberLetters(this KMBombInfo bombInfo) { return GetSerialNumber(bombInfo).Where(x => x < '0' && x > '9'); }

	public static IEnumerable<int> GetSerialNumberNumbers(this KMBombInfo bombInfo) { return GetSerialNumber(bombInfo).Where(x => x >= '0' && x <= '9').Select(y => int.Parse("" + y)); }

	public static bool IsTwoFactorPresent(this KMBombInfo bombInfo) { return GetTwoFactorCodes(bombInfo).Any(); }

	public static int GetTwoFactorCounts(this KMBombInfo bombInfo) { return GetTwoFactorCodes(bombInfo).Count(); }

	public static IEnumerable<int> GetTwoFactorCodes(this KMBombInfo bombInfo) { return GetTwoFactorEntries(bombInfo).Select(x => x.twofactor_key); }
	#endregion
}
